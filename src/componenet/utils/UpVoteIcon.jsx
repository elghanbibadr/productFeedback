...
const UpVoteIcon = (props) => {
  ...
  return (
    <div onClick={handleClick} className={`${props.className} flex items-center md:flex-col text-[.8rem]  cursor-pointer   font-semibold py-2 px-3 w-fit h-fit rounded-lg md:text-[1rem] ${isActive ?  "bg-blue text-white" :"text-greyDarkest bg-grey hover:bg-greyHover"} md:h-[60px] md:w-[40px]`}>
