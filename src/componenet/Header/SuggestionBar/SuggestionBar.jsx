...
const SuggestionBar = () => {
  return (
    <div className='bg-greyDarkest relative md:rounded-xl whitespace-nowrap p-4 flex-row-between flex-nowrap '>
        <div className='flex items-center justify-around md:w-4/5'>
          <div className='hidden md:flex items-center'>
            ...
            <Btn className='bg-purple whitespace-nowrap   hover:bg-purpleHover' text='+ Add feedback' />
    </div>
  )
}
