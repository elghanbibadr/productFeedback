...
const SuggestionCard = () => {
  return (
    <Card className='p-6 grid grid-cols-2 grid-row-[1fr_100px] gap-y-10 md:grid md:grid-cols-6 md:grid-rows-1'>
        <div className='col-span-2 md:col-span-4  md:col-start-2 '>
          ...
          <div>
              ...
              <UpVoteIcon className='md:col-start-1 md:row-start-1 md:self-center '  text='99'/>
